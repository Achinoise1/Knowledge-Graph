...
def MatchWithOriginDic(Dic,DicOri):
    ...
    for i in range(0,len(KeysD)):
        if ContentTitle[0] == KeysD[i]:
            ContentTitle[0] = KeysDO[i]
        if ContentTitle[1] == KeysD[i]:
            ContentTitle[1] = KeysDO[i]
        if ContentTitle[2] == KeysD[i]:
            ContentTitle[2] = KeysDO[i]
